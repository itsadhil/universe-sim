...
public class GrabingFunctionsVR : MonoBehaviour
{
    ...
    public Terrain targetTerrain; // Terrain that will receive the texture
    ...
    void GrabItem(GameObject item)
    {
        ...
        ChangeTerrainMaterial(currentItem); // Change terrain material when picking up
